...
let FoodsService = class FoodsService {
    ...
    async deleteFood(deleteFoodDto, req) {
        ...
        if (food.restaurant.id !== restaurantId) {
            throw Error("Only Product owner can delete product!");
        }
...
tslib_1.__decorate([
    ...
    (0, class_validator_1.IsString)({ message: "Product Name must need to be one string." }),
    tslib_1.__metadata("design:type", String)
], CreateFoodDto.prototype, "name", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    (0, class_validator_1.IsNotEmpty)({ message: "Product description is required." }),
    (0, class_validator_1.IsString)({ message: "Product description must need to be one string." }),
    tslib_1.__metadata("design:type", String)
...
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    (0, class_validator_1.IsNotEmpty)({ message: "Product estimated price is required." }),
    tslib_1.__metadata("design:type", Number)
], CreateFoodDto.prototype, "estimatedPrice", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(),
    (0, class_validator_1.IsNotEmpty)({ message: "Product category is required." }),
    (0, class_validator_1.IsString)({ message: "Product category must need to be one string." }),
    tslib_1.__metadata("design:type", String)
], CreateFoodDto.prototype, "category", void 0);
tslib_1.__decorate([
    (0, graphql_1.Field)(() => [String]),
    (0, class_validator_1.IsArray)({ message: "Product images must be an array." }),
    (0, class_validator_1.ArrayNotEmpty)({ message: "Product images array must not be empty." }),
    tslib_1.__metadata("design:type", Array)
...
tslib_1.__decorate([
    ...
    (0, class_validator_1.IsString)({ message: "Product id must need to be one string." }),
    tslib_1.__metadata("design:type", String)
